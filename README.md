...
This repo has all materials for the delivery and creation of the accreditted icAgile Programming course.
...
- [Jenkins CICD - Intro](https://app.qa.com/course/jenkins-cicd/using-jenkins-create-cicd-pipelines/)
...
## Commands to run to update each individual subtree learning module
...
git subtree add --prefix 04_UnitTesting https://gitlab.com/qa-software-engineering/learning-modules/testing/unit-testing.git master --squash
